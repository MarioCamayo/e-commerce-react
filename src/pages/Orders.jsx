                ...
                flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div className="flex items-start gap-6 text-sm ">
                          <img 
                                ...
                                src= {item.image[0]} alt="item.image"
                          />
                          <div>
                            ...
                            <p className="mt-2">Date: <span className="text-gray-400">27, Enero, 2025</span> 
                            </p>
                          </div>
                      </div>
                      ...
                      <div className="md:w-1/2 flex justify-between">
                          ...
                          <button className="border px-4 py-2 text-sm font-medium rounded-sm">Seguimiento del pedido</button>
